...
export const GENERAL_REGLAMENTO_ROUTE = "/reglamento";
export const ARROYOS_REGLAMENTO_ROUTE = "/reglamento/arroyos";
...
export function getUrbanizationReglamentoRoute(slug: string) {
  return slug === ARROYOS_URBANIZATION_SLUG
    ? ARROYOS_REGLAMENTO_ROUTE
    : GENERAL_REGLAMENTO_ROUTE;
}
